...
- **Ensemble:** `docs_private/notebooks/function_0_devel.ipynb` implements ensemble acquisition (EI+PI+UCB): centroid when they disagree, EI when they agree. See `docs_private/notes_and_references/ensemble_acquisition_guide.md`.

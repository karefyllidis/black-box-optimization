...
- **Docs:** `README.md` (overview, workflow, structure), `docs/project_roadmap.md` (structure and roadmap), `docs/TECHNICAL_FOUNDATIONS.md` (justification and references). **Scripts:** `run_all.py` runs any `scripts/*.py` (e.g. `append_week1_results.py` … `append_week5_results.py`) then prints submission strings.
